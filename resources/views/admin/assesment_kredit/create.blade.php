...
@section('title', 'Tambah Arsip Assesment Kredit')
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Tambah Arsip Assesment Kredit</h5>
                ...
                {!! Form::open(['route' => 'admin.assesment-kredit.store', 'method' => 'POST', 'files' => true]) !!}
                ...
                <div class="col-12 mt-3">
                    ...
                    {!! Form::text('nomor_kredit', old('nomor_kredit'), ['class' => 'form-control']) !!}
                </div>
