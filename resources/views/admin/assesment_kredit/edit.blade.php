...
@section('title', 'Edit Arsip Assesment Kredit')
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Edit Arsip Assesment Kredit</h5>
                ...
                {!! Form::open(['route' => ['admin.assesment-kredit.update', $record->id], 'method' => 'PUT', 'files' => true]) !!}
                ...
                <div class="col-12 mt-3">
                    {!! Form::label('nomor_kredit', 'Nomor Kredit', ['class' => 'form-label']) !!}
                    {!! Form::text('nomor_kredit', old('nomor_kredit', $record->nomor_kredit), ['class' => 'form-control']) !!}
                </div>
                ...
                @if($record->file)
                    <div class="col-12 mb-2">
                        <a href="{{ route('admin.assesment-kredit.file', $record->id) }}" target="_blank" class="btn btn-sm btn-light">
                ...
                <div class="col-12 mt-4 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.assesment-kredit.index') }}" class="btn btn-light">Batal</a>
                </div>
