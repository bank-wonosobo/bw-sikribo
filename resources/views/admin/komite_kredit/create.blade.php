...
@section('title', 'Tambah Arsip Komite Kredit')
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Tambah Arsip Komite Kredit</h5>
                ...
                {!! Form::open(['route' => 'admin.komite-kredit.store', 'method' => 'POST', 'files' => true]) !!}
